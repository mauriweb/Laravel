...
<body>
           <div class="contenedor">
				...
				<table width="80%" class="text_left" style="margin-left:auto; margin-right:auto; position:relative;">
                	<thead>
                        <tr class="min">
                            <td width="40%" class="minimo_titulo">{{ HTML::image('img/logo_color.png', 'Imagen usuario', array('width'=>'100', 'height'=>100)) }}</td> 
                ...
                <table width="80%" class="text_left table_gran"  style="margin-left:auto; margin-right:auto; position:relative;">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:50%;"><small>Tipo de envio:</small> <strong>{{($pedido->envio=='e')?'Envian':'Recojen';}}</strong></td>
                            </tr>
                            <tr>
                                <td style="width:50%;"><small>Persona que pasa pedido:</small> <strong>{{$pedido->User->username}}</strong>	</td>
                ...
                <table width="80%" class="table_gran"  style="margin-left:auto; margin-right:auto; position:relative; margin-top:20px; text-align:center;">
                    ...
                    <tbody>
                        @foreach($pedido->PedidosDetalle as $pedDet)
                            <tr>
                                <td><small>{{$pedDet->cantidad}}</small></td>
                                <td><small>{{$pedDet->FormatosPedido->formato}}</small></td>
                                <td><small>{{$pedDet->Producto->nombreProducto}}</small></td>
                            </tr>
                            @endforeach
