						...
						<div class="portlet-body">
                            ...
                            <form action="{{URL::to('/add-proveedores')}}" class="form-horizontal" role="form" method="post">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" name="nombre" class="form-control" {{ (Input::old('nombre'))? 'value="'.Input::old('nombre').'"': '' }}  placeholder="Insertar nombre">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Domicilio</label>
									<div class="col-md-10">
										<input type="text" name="domicilio" class="form-control" {{ (Input::old('domicilio'))? 'value="'.Input::old('domicilio').'"': '' }}   placeholder="Insertar domicilio">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">CP</label>
									<div class="col-md-10">
										<input type="text" name="cp" class="form-control" {{ (Input::old('cp'))? 'value="'.Input::old('cp').'"': '' }}   placeholder="Insertar CP">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Población</label>
									<div class="col-md-10">
										<input type="text" name="poblacion" class="form-control" {{ (Input::old('poblacion'))? 'value="'.Input::old('poblacion').'"': '' }}   placeholder="Insertar población">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Ciudad</label>
									<div class="col-md-10">
										<input type="text" name="ciudad" class="form-control" {{ (Input::old('ciudad'))? 'value="'.Input::old('ciudad').'"': '' }}   placeholder="Insertar ciudad">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Pais</label>
									<div class="col-md-10">
										<input type="text" name="pais" class="form-control" {{ (Input::old('pais'))? 'value="'.Input::old('pais').'"': '' }}   placeholder="Insertar pais">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Teléfono</label>
									<div class="col-md-10">
										<input type="text" name="tel" class="form-control" {{ (Input::old('tel'))? 'value="'.Input::old('tel').'"': '' }}   placeholder="Insertar teléfono">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Fax</label>
									<div class="col-md-10">
										<input type="text" name="fax" class="form-control" {{ (Input::old('fax'))? 'value="'.Input::old('fax').'"': '' }}   placeholder="Insertar fax">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Email</label>
									<div class="col-md-10">
										<input type="email" name="email" class="form-control" {{ (Input::old('email'))? 'value="'.Input::old('email').'"': '' }}   placeholder="Insertar email">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Persona de contacto</label>
									<div class="col-md-10">
										<input type="text" name="contacto" class="form-control" {{ (Input::old('contacto'))? 'value="'.Input::old('contacto').'"': '' }}   placeholder="Insertar persona de contacto">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Datos de interes</label>
									<div class="col-md-10">
										<textarea name="datosInteres" class="form-control" rows="3">{{ (Input::old('datosInteres'))? Input::old('datosInteres'): '' }}  </textarea>
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Teléfono de pedidos</label>
									<div class="col-md-10">
										<input type="text" name="telPedidos" class="form-control" {{ (Input::old('telPedidos'))? 'value="'.Input::old('telPedidos').'"': '' }}  placeholder="Insertar teléfono de pedidos">
									</div>
								</div>
                                <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Fax de pedidos</label>
									<div class="col-md-10">
										<input type="text" name="faxPedidos" class="form-control" {{ (Input::old('faxPedidos'))? 'value="'.Input::old('faxPedidos').'"': '' }}  placeholder="Insertar fax de pedidos">
									</div>
								</div>
                                <hr>
								<div class="form-group">
