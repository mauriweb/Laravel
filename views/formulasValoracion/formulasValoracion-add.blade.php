				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
                            ...
                            <hr>
							<h4>Nuevo formula</h4>
                                                        <form id="general-form" action="{{URL::to('add-formula-valoracion')}}" class="form-horizontal" method="post" role="form">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-10">
                                                                            <input tabindex="1" id="nombre" type="text" class="form-control"  name="nombre" {{ (Input::old('nombre')) ? 'value="'.Input::old('nombre').'"' : '' }} placeholder="Insertar nombre de formula">
									</div>
								</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-md-10">
                                                                            <textarea tabindex="2" id="observaciones" class="form-control" rows="3" name="observaciones">{{ (Input::old('observaciones')) ? Input::old('observaciones') : '' }}</textarea>
									</div>
								</div>
							...
							<div class="table-responsive">
								...
								<tr>
                                    ...
                                    <td>
                                        {{ Form::select('det-codigo-1', $productoCode, Input::old('det-codigo-1'), array('class'=>'select2_category form-control codigo', 'tabindex'=>'3') ) }}
									</td>
                                    
									<td>
                                                                            <input tabindex="4" name="det-cantidad-1" {{ (Input::old('det-cantidad-1')) ? 'value="'.Input::old('det-cantidad-1').'"' : '' }} type="text" class="form-control cantidad" placeholder="Cantidad">
									</td>
                                    
                                    <td>
                                        <input tabindex="-1" name="det-productoName-1" {{ (Input::old('det-productoName-1')) ? 'value="'.Input::old('det-productoName-1').'"' : '' }} class="form-control productoName" type="text" readonly="" placeholder="Sale de base">
									</td>
                                    <td>
                                        <input tabindex="-1" name="det-coste-1" {{ (Input::old('det-coste-1')) ? 'value="'.Input::old('det-coste-1').'"' : '' }} class="form-control coste" type="text" readonly="" placeholder="Sale de base">
									</td>
                                    <td>
										<input tabindex="-1" name="det-importe-1" {{ (Input::old('det-importe-1')) ? 'value="'.Input::old('det-importe-1').'"' : '' }} class="form-control importe" type="text" readonly="" placeholder="Sale de formula">
									</td>
                                    <td>
                        ...
                        <div class="form-group">
									...
									<div class="col-md-10">
										<input tabindex="-1" name="importeTotal" {{ (Input::old('importeTotal')) ? 'value="'.Input::old('importeTotal').'"' : '' }} class="form-control importeTotal" type="text" readonly="" placeholder="Sale de formula">
									</div>
						</div>
                          <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Peso formula</label>
									<div class="col-md-10">
										<input tabindex="-1" name="pesoTotal" {{ (Input::old('pesoTotal')) ? 'value="'.Input::old('pesoTotal').'"' : '' }} class="form-control pesoTotal" type="text" readonly="" placeholder="Sale de formula">
									</div>
						</div>
                          <div class="form-group">
									<label for="inputEmail1" class="col-md-2 control-label">Precio por kg. €</label>
									<div class="col-md-10">
										<input tabindex="-1" name="precioXkg" {{ (Input::old('precioXkg')) ? 'value="'.Input::old('precioXkg').'"' : '' }} class="form-control precioXkg" type="text" readonly="" placeholder="Sale de formula">
									</div>
						</div>
...
<script >
 var cant=Array();
                            ...
                            @if(Session::has('importe'))
                                {{Session::get('importe')}}
                            @endif
                            @if(Session::has('porcentaje'))
                                {{Session::get('porcentaje')}}
                            @endif
